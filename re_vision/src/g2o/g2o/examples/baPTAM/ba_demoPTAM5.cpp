...
{
   Token t;
   if(t.abrirFichero("experimento.mat") != Token::ok)
   {
...
///////////////////
  ...
  g2o::VertexKFOV5 *vK0, *vKF, *vKGT;

  vKGT = new g2o::VertexKFOV5(gt.cal[0], gt.cal[1], gt.cal[2], gt.cal[3], gt.cal[4]);
  if(CAL_CORRECTA)
  {
     vK0 = new g2o::VertexKFOV5(gt.cal[0], gt.cal[1], gt.cal[2], gt.cal[3], gt.cal[4]);
     vK0->setFixed(true);
     vKF = new g2o::VertexKFOV5(gt.cal[0], gt.cal[1], gt.cal[2], gt.cal[3], gt.cal[4]);
     vKF->setFixed(true);
  }else
  {
...
//     vKF = new g2o::VertexKFOV5(f, f, gt.w>>1, gt.h>>1, 60*M_PI/180);
     ...
     cal(4) = /*Sample::gaussian(0.05*gt.cal[4]) +*/ 1.05 * gt.cal[4];
     vK0 = new g2o::VertexKFOV5(cal[0], cal[1], cal[2], cal[3], cal[4]);
     vKF = new g2o::VertexKFOV5(cal[0], cal[1], cal[2], cal[3], cal[4]);
