...
namespace g2o {
  ...
  /**
   * \brief base class to represent an edge connecting an arbitrary number
   *        of nodes
  ...
  class BaseMultiEdge : public BaseEdge<D,E>
  {
    public:
      /**
       * \brief helper for mapping the Hessian memory of the upper triangular
       *        block
       */
    ...
    public:
      ...
      typedef Map<MatrixXd, MatrixXd::Flags & AlignedBit ? Aligned : Unaligned >
         HessianBlockType;
