...
:- owl_parser:owl_parse('/home/vitalij/ros/stacks/roboearth/re_ontology/owl/roboearth.owl', false, false, true).
:- rdf_db:rdf_register_ns(roboearth, 'http://www.roboearth.org/kb/roboearth.owl#',     [keep(true)]).


%:- owl_parser:owl_parse('/home/vitalij/ros/stacks/roboearth/re_ontology/owl/fmi_hospital_room.owl', false, false, true).


% :- owl_parser:owl_parse('/home/vitalij/ros/stacks/roboearth/re_ontology/owl/object_model.owl', false, false, true).
% :- rdf_db:rdf_register_ns(re_object_model, 'http://www.roboearth.org/kb/object_model.owl#',     [keep(true)]).

% :- owl_parser:owl_parse('/home/vitalij/ros/stacks/roboearth/re_ontology/owl/joystick_drive.owl', false, false, true).
% :- rdf_db:rdf_register_ns(re_joystick_drive, 'http://www.roboearth.org/kb/joystick_drive.owl#',     [keep(true)]).

% :- owl_parser:owl_parse('/home/vitalij/ros/stacks/roboearth/re_ontology/owl/environment_map.owl', false, false, true).
% :- rdf_db:rdf_register_ns(re_environment_map, 'http://www.roboearth.org/kb/environment_map.owl#',     [keep(true)]).

% :- owl_parser:owl_parse('/home/vitalij/ros/stacks/roboearth/re_ontology/owl/set_a_table.owl', false, false, true).
