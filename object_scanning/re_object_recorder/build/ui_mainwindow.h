...
**
** Created: Mon Oct 21 11:21:05 2013
...
public:
    ...
    QDoubleSpinBox *markerSpacingDoubleSpinBox;
    ...
    void setupUi(QWidget *MainWindow)
    {
        ...
        label_8 = new QLabel(recordTab);
        label_8->setObjectName(QString::fromUtf8("label_8"));

        formLayout_2->setWidget(2, QFormLayout::LabelRole, label_8);

        label_9 = new QLabel(recordTab);
        label_9->setObjectName(QString::fromUtf8("label_9"));

        formLayout_2->setWidget(3, QFormLayout::LabelRole, label_9);

        markerSizeDoubleSpinBox = new QDoubleSpinBox(recordTab);
        markerSizeDoubleSpinBox->setObjectName(QString::fromUtf8("markerSizeDoubleSpinBox"));
        markerSizeDoubleSpinBox->setDecimals(4);
        markerSizeDoubleSpinBox->setMinimum(0.0001);
        markerSizeDoubleSpinBox->setMaximum(2);
        markerSizeDoubleSpinBox->setSingleStep(0.01);
        markerSizeDoubleSpinBox->setValue(0.08);

        formLayout_2->setWidget(2, QFormLayout::FieldRole, markerSizeDoubleSpinBox);

        markerSpacingDoubleSpinBox = new QDoubleSpinBox(recordTab);
        markerSpacingDoubleSpinBox->setObjectName(QString::fromUtf8("markerSpacingDoubleSpinBox"));
        markerSpacingDoubleSpinBox->setDecimals(4);
        markerSpacingDoubleSpinBox->setMinimum(0.0001);
        markerSpacingDoubleSpinBox->setMaximum(2);
        markerSpacingDoubleSpinBox->setSingleStep(0.01);
        markerSpacingDoubleSpinBox->setValue(0.11);

        formLayout_2->setWidget(3, QFormLayout::FieldRole, markerSpacingDoubleSpinBox);
...
#endif // QT_NO_TOOLTIP
        label_8->setText(QApplication::translate("MainWindow", "Marker Size (in m):", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("MainWindow", "Marker Spacing (in m):", 0, QApplication::UnicodeUTF8));
