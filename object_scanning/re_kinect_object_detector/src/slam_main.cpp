...
public:
    ROSCom() {
        ros::NodeHandle nh;        
	kinect_sub = nh.subscribe<sensor_msgs::PointCloud2>("camera/depth_registered/points",1, boost::bind(&ROSCom::kinect_cb,this,_1));
//        kinect_sub = nh.subscribe<sensor_msgs::PointCloud2>("kinect1/depth/points",1, boost::bind(&ROSCom::kinect_cb,this,_1));
